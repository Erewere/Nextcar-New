        ...
        <FadeIn className="bg-white p-10 rounded-3xl shadow-xl w-full max-w-md border border-gray-100">
          ...
          <div className="space-y-4">
            ...
            <button 
              ...
              disabled={loading}
              className="w-full bg-white text-black border border-gray-200 py-4 rounded-xl font-bold hover:bg-gray-50 transition-all flex items-center justify-center gap-3"
            >
